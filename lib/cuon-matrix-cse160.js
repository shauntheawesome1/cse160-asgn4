...
class Vector3 {
  ...
  add(other) {
    ...
    // Summing the two Vectors and keeping the result in the first Vector
  ...
  sub(other) {
    ...
    // Subtracting the first Vector from the second Vector and keeping the result in the first Vector
    this.elements[0] = this.elements[0] - other.elements[0];
    this.elements[1] = this.elements[1] - other.elements[1];
    this.elements[2] = this.elements[2] - other.elements[2];
  ...
  div(scalar) {
    ...
    // Scalar dividing a Vector and keeping the result in it
  ...
  mul(scalar) {
    ...
    // Scalar multiplying a Vector and keeping the result in it
    this.elements[0] = this.elements[0] * scalar;
    this.elements[1] = this.elements[1] * scalar;
    this.elements[2] = this.elements[2] * scalar;
  ...
  static dot(other1, other2) {
    ...
    // Computing the dot product of the first and second Vectors and keeping the result in d
  ...
  static cross(other1, other2) {
    ...
    // Calculating the cross product of the first and second Vectors and storing it in a new third Vector
    let element1 = (other1.elements[1] * other2.elements[2]) - (other1.elements[2] * other2.elements[1]);
    let element2 = ((other1.elements[0] * other2.elements[2]) - (other1.elements[2] * other2.elements[0])) * (-1);
  ...
  magnitude() {
    ...
    // Computing the magnitude of a Vector by using the Pythagorean Formula
    let m = 0;
    m = Math.sqrt(Math.pow(this.elements[0], 2) + Math.pow(this.elements[1], 2) + Math.pow(this.elements[2], 2)); // Modify this line to calculate this vector's magnitude.
  ...
  normalize() {
    ...
    // Normalizing a Vector by dividing each of its components by the magnitude
